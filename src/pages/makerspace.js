  ...
  return (
    <body>
      ...
      <div className="flex-parent" style={{display:"flex", flexDirection:"column", alignItems:"center", width: "100vw", padding:"0vw 10vw"}}>
        ...
        <PageHero texture_img={texture} hero_img={about_hero} title={"MAKERSPACE"} subtitle={"Check back soon for access!"} />
        ...
        <div className="lightblue-div img-div">
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
                ...
                <span style={{ color: "var(--illini-blue)" }}>Check back soon for access!</span>
            </div>
        </div>
        <Paragraph 
