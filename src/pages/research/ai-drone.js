...
const AIDronePage = () => {
  return (
    <body>
      <Helmet
        title="IoT@Illinois - AI Drone Research"
        meta={[
      ...
      />
      <Navigation />
      <SubPageHero hero_img={hero}  title={"AI Drone Research"} subtitle={"Insert problem statement of project"}/>      
    </body>
  )
}

export default AIDronePage
