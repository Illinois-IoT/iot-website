              ...
              <Navbar collapseOnSelect expand='sm' className="navbar" onToggle={()=> this.toggleExpand()} id={this.state.navbarClass === "navbar-secondary" ? "box-shadow" : ""}>
                  ...
                  <Navbar.Collapse id="responsive-navbar-nav"> {/*navbar background*/}
                      <Nav className="mr-auto" id="nav"> {/*actual navbar*/}
                          ...
                          <NavDropdown onClick={()=>this.open("/capstone-showcase")} href="/capstone-showcase" id="nav-dropdown" style={{whiteSpace:"nowrap"}} title={<p id="navbar-item">Capstone Showcase &#9660;</p>} renderMenuOnMount={true} style={{...this.state.navbarClass=== "navbar-expanded" ? {visibility: "hidden"} : {visibility: "visible"}}}>
