              ...
              <Navbar collapseOnSelect expand='sm' className="navbar" onToggle={()=> this.toggleExpand()} id={this.state.navbarClass === "navbar-secondary" ? "box-shadow" : ""}>
                  ...
                  <Navbar.Collapse id="responsive-navbar-nav"> {/*navbar background*/}
                      <Nav className="mr-auto" id="nav"> {/*actual navbar*/}
                          ...
                          <NavDropdown onClick={()=>this.open("/capstone-showcase/fall-2024")} href="/capstone-showcase/fall-2024" id="nav-dropdown" style={{whiteSpace:"nowrap"}} title={<p id="navbar-item">Capstone Showcase &#9660;</p>} renderMenuOnMount={true} style={{...this.state.navbarClass=== "navbar-expanded" ? {visibility: "hidden"} : {visibility: "visible"}}}>
            ...
            <Navbar collapseOnSelect expand='sm' expanded={this.state.mobile_expanded} className="navbar-mobile">
                  ...
                  <Navbar.Collapse id="responsive-navbar-nav"> {/*navbar background*/}
                      <Nav className="mr-auto" id="nav" justify-content-center> {/*actual navbar*/}
                        ...
                        <Nav.Link href="/capstone-showcase/fall-2024" className='mobile-navlink'><h5 id="navbar-item" className="subscript">Capstone Showcase</h5></Nav.Link>
                      </Nav>
                  </Navbar.Collapse>
              </Navbar>
            </div>
